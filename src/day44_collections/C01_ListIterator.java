...
public class C01_ListIterator {
    public static void main(String[] args) {
        ...
        while(li1.hasNext()){              //loop listIterator li1 imiz yanında eleman oldukça çalışacak

            Integer temp=(Integer)li1.next();  //obje getireceği için child classı Integera cast ettik
            //iterator next i her gördüğünde yana gideceği için if den önce tempe atama yaptık
            // if (li1.next()<basSinir || li1.next()>bitSinir)
