...
public class C02_ListIterator {
    public static void main(String[] args) {
        ...
        while(li1.hasNext()){         //yanda eleman varmı olduğu müddertçe true
            li1.next();              // AL yana geç
        }
        // bu loop bizi sona goturur

        //başa dönecez

        while(li1.hasPrevious()){                                  //önünde elamn varsa true
            System.out.print(li1.previous()+ " ");                //al sırtlanır yazdırdık
        }
    }
}