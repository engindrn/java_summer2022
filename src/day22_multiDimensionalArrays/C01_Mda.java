...
public class C01_Mda {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sayilar[0]); // [I@58ceff1   refaransı verdi çünkü sayılar[0] bir Arraydiir

        System.out.println(Arrays.toString(sayilar[0])); // [1, 2, 4, 5] // bu şekilde yazdırır

        System.out.println(sayilar[0][1]); // 2 // 0 inci inner arreiyin 1 inci indexindeki elementi old için drk yazdı
        System.out.println(sayilar[1][0]); // 3

        System.out.println(Arrays.toString(sayilar)); // [[I@58ceff1, [I@7c30a502]
        //tüm arrayi ,arrayin içinde array olduğu için bu şekildede yazdırmaz

        System.out.println(Arrays.deepToString(sayilar)); // [[1, 2, 4, 5], [3, 4]]
        //bu şekilde arraydeki bütün elementler yazdırırlır
