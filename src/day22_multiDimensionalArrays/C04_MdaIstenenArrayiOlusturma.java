...
public class C04_MdaIstenenArrayiOlusturma {
    ...
    public static void main(String[] args) {
        ...
        int[] yeniArr=new int[input.length];          //yeni arrayimiz input arrayin outer array uzunluğu kadar olacak
                                                      //dinamik olamsı için 3 yazmak yerine input.lengt yazdık

        int toplam=0;     //her yerden ulaşabilmek için loop dışında oluşturudk (scope)
