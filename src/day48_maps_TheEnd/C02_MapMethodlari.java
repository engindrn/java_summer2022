...
public class C02_MapMethodlari {
    ...
    public static void main(String[] args) {
        ...
        ReusableMethods.entryYazdir(sinifListMap); // bir method daha oluşturduk

        sinifListMap.clear();
        System.out.println("cleardan sonra map : " + sinifListMap);

        sinifListMap=ReusableMethods.mapOlustur();   //clear dan sonra tekrar atadık
        ...
        sinifListMap.replace(105,"Erdal, Ciftci, Tester");  //105 i erdal ciftci tester yaptık
