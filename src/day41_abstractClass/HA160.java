...
public class HA160 extends FMercedes {
    ...
    public static void main(String[] args) {
        ...
        EToyota arb4= new GCorolla();    //data türü abstract  class olduğu için constructorı child classdan yaparak
                                            //obje oluşturabildik
        ...
        constructor'i ise child'i olan concrete bir class'dan seceriz bu şekilde obje üretebiliriz
         */
    }
}