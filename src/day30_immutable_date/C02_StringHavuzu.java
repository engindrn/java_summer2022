...
public class C02_StringHavuzu {
    ...
    public static void main(String[] args) {
        ...
        String str1 = "Ali Can";
        String str2 = str1+"";     //Ali Can ın yanınz hiçilk ekledik
        String str3 = new String("Ali Can");
        String hiclik="";
        String str4 = str1.concat(hiclik);     //Ali Can ile hiçliği concat yaptık  str2 ve str4 ayni olur
        ...
        /*
          ...
          bire-bir aynisi yoksa yeni bir obje ve ref olusturur
           ...
           double equal sign hem referansa hem değerleri kontrol eder
           equals methodu ise sadece derğerileri kont eder
         */
    }
}