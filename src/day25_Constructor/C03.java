...
public class C03 {
    ...
    //class ismi ile aynı isim
    //contructor olduğu anlaşılması için normal parantez
    //kodları yazılacağı curly braces

    //class'ın içerisinde varsa main method dışında oluşturulur
