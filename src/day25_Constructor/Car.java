...
public class Car {
    ...
    String marka="Marka belirtilmedi";      //kullanıcı tarafından girilmediği taktirde default değer yerine bunu girik
    String model="Model belirtilmedi";    //kullanıcı tarafından girilmediği taktirde default değer yerine bunu girik
    int yil;                             //değer atamadık
    public int fiyat;                          //değer atamadık
