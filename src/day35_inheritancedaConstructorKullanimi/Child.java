...
public class Child extends BParent {
    ...
    public static void main(String[] args) {
        ...
        // bu objeyi olusturmak icin Granpa Cons. calisir,(o classdan obje oluşturduk sadece orası çalışır)
        // Parent veya Child cons calismaz


         Child child1=new Child();    //içinde bulunduğumuz classdan bir obje oluşturduk

        child1.granpaKlupAdi="Child1";    //extends ile ulaşabildik ve değiştirdik
        child1.parentKlupAdi="Child2";    //extends ile ulaşabildik ve değiştirdik

        // child1 objesi icin Child cons calisir

        //javada başka bir class a gidebilmek ve o claası kullanabilmek için o classın contructorunu kullanmak zorundayız
        /*
