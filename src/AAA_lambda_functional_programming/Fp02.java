...
public class Fp02 {
    ...
    public static void tekrarsizCiftElemanlarinKareToplami02(List<Integer> list){
        ...
        System.out.println(toplam);                                                             //math classından toplama methodu
    ...
    public static void tekrarsizCiftElemanlarinKareToplami03(List<Integer> list){
        ...
        System.out.println(toplam);                                                     //Integer classından toplama methodu
    ...
    public static void  tekrarsizCiftElemanlarinKupleriniCarpimi(List<Integer> list){
        ...
        System.out.println(carpim);                                                         //math classından çarpma methodunu aldık
    }                                                                                       //başlangıç değeri kulanarak yada get() ile yapılır

        //7) List elemanları arasından en büyük değeri bulan bir method oluşturun.

    public static void getMaxEleman(List<Integer> list){

        Integer max = list.stream().distinct().reduce(Math::max).get();   //math classından max değeri alma methodu
    ...
    //8)List elemanları arasından en küçük değeri bulan bir method oluşturun.(Method Reference)
      ...
      Integer minDeger=  list.stream().distinct().reduce(Math::min).get();  //math classından min değeri alma methodu

          System.out.println("minDegeriBulma: " + minDeger);
    ...
    public static void yedidenBuyukCiftMin(List<Integer> list){
        ...
        System.out.println(min);      //çok kullanılmayacağı için lambda expression ile yaptık method oluşturmadık
    }

    //10) Ters sıralama ile tekrarsız ve 5'ten büyük elemanların yarı değerlerini(elamanın ikiye bölüm sonucunu) bulan bir method oluşturun.
    public static void terSiralamaylaTekrarsizElemanlarinYarisi(List<Integer> list){
        List<Double> sonuc = list.                                   //methoddan double bir sonuç döneceği için double list
