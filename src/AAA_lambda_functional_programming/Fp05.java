...
public class Fp05 {
    ...
    public static void main(String[] args) {
        ...
        List<Courses> coursesList = new ArrayList<>();    // yukarıda oluşturduğumuz objeleri bu liste ekledik
                                                        //böylelikle yukardaki objerin olduğu bir list elde ettik
                         //data tipi olrak oluşturudğumuz classı seçtik orataki methodları kullanacağız-getter,setter
