...
public class C04_ArrayOlustur {
    ...
    public static void main(String[] args) {
        ...
        int[] sayilar= arrayOlustur();       //method ismi

        System.out.println(Arrays.toString(sayilar));   //return edilen sonucu görmek için yazdırdık
    }
    public static int[] arrayOlustur() {
        ...
        int[] olusturulan =new int[uzunluk];      //yeni bir array oluşturduk uzunluk olarak kullanıcıdan aldığımızı ekledik
