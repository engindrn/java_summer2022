...
public class C10_split {
    ...
    public static void main(String[] args) {
        ...
        String str="Java, ne kadar guzel.";
         ...
         //methodu kullanınca bize String bir Array (String[] )döneceği için ya yazdırmamız lazım
        //yada String bir Array e atamamız lazım.

        System.out.println(Arrays.toString(str.split(""))); //atama yapmadan direk yazdırdık
          //[J, a, v, a, ,,  , n, e,  , k, a, d, a, r,  , g, u, z, e, l, .]

                            //atama yapıp yazıdırdık
