...
public class ArabaRunner {
    public static void main(String[] args) {
        ...
        Car car1=new Car();              //ilerde detaylı göreceğiz; day25 car class ından oluşturduğumuz obje sadece
        System.out.println(car1.fiyat);  //public olan iki methodu ve public yaptığımız fiyat variable ını görebildi.
        ...
        araba1.fiyat=10000;              //bu değerleri burda atamasaydık bize obje oluşturduğumuz arabaclassındaki
        araba1.marka="Mercedes";        //atanan değerleri atayacaktı ordada değer ataması yapılmadıysa javanın
        araba1.yil=2010;                //default değerlerini atayacaktı
        araba1.model="C180";
        ...
        Araba araba2=new Araba("BMW","5.20",2011,15000); //argumanları girdik ve
                                                                                // create contructor dedik
