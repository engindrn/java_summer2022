...
public class C01_PassByValue {
    ...
    public static void elemanDegistir(int[] arr) {
        ...
        arr[1]=rnd.nextInt(100);   //index 1 e yani 2. elemana random bir değer atadık. bound 100 yüzden küçük
        arr[3]=rnd.nextInt(100);    //index 3 e yani 4. elemana random bir değer atadık
