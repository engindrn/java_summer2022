...
public class C04_ExceptionTurleri {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(5000);   //kodları istediğimiz süre kadar bekletir.
        // oluşturduğumuzda compile time exception verir bu yüzden ya try catch bloğuna alınmalı yada
        // add exception to method signature deyip methodun yanına ekler
    }
}