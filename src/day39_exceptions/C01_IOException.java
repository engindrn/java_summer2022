...
public class C01_IOException {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        //dosyayı okuması için bu objeyi oluşturduktan sonra dosya path/reference si parantez içine yazılı
        //onuda test dosyası üzerinde sağ tuş yapıp Copy path/reference e basıp path from content root seçeriz
        //çift tırnak içine yapıştırırız
