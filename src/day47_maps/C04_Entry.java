...
public class C04_Entry {
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<Integer,String> each: sinifEntrySet
            ...
            eachValue= each.getValue();          //burda value leri aldık atadık
            eachValue=eachValue.replace("Tester", "QA");   //değerlri değiştirdik
            each.setValue(eachValue);    //yeni değerleri map e atadık
        }
        System.out.println(sinifListMap);
    }
}
